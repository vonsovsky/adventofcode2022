...
def bfs(grid, x, y, end_x, end_y, time):
    max_x = len(grid[0]) - 2
    max_y = len(grid) - 2
    queue = [(x, y, time)]
...
steps1 = bfs(grid, 0, -1, max_x - 1, max_y - 1, 0)
visited_nodes = set()
print(steps1)

steps2 = bfs(grid, max_x - 1, max_y, 0, 0, steps1)
visited_nodes = set()
print(steps2)

steps3 = bfs(grid, 0, -1, max_x - 1, max_y - 1, steps2)
visited_nodes = set()
print(steps3)
